...
export default function PageHeader({ title }) {
  ...
  return (
    <>
      ...
      <div style={{ position: 'sticky', top: 0, zIndex: 1000, background: t.navBg, padding: '12px 16px', display: 'flex', alignItems: 'center', gap: '4px', flexShrink: 0, borderBottom: `1px solid ${t.accent}4D`, boxShadow: t.bg === '#e6e6e6' ? '0 2px 8px rgba(0,0,0,0.08)' : '0 4px 24px rgba(99,102,241,0.15), 0 1px 0 rgba(99,102,241,0.05) inset' }}>
