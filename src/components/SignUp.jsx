      ...
      <div style={{ background: '#2d3748', width: '92vw', maxWidth: '360px', position: 'relative', zIndex: 1 }}>
        ...
        <div style={{ padding: '16px', display: 'flex', flexDirection: 'column', gap: '10px' }}>
          ...
          <div style={{ display: 'flex', gap: '8px' }}>
            ...
            <div style={{ flex: 1 }}>
              <label style={{ color: 'rgba(255,255,255,0.6)', fontSize: '8px', fontWeight: '600', display: 'block', marginBottom: '4px' }}>Referral Code <span style={{ color: 'rgba(255,255,255,0.25)' }}>(Optional)</span></label>
