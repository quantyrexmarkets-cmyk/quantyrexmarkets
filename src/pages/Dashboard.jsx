          ...
          <div style={{ flex: 1, overflowY: 'auto', padding: '12px', minWidth: 0 }}>
            ...
            <div style={{ position: 'relative', borderRadius: '16px', overflow: 'hidden', marginBottom: '20px', background: t.bg === '#f8fafc' ? t.cardBg : 'linear-gradient(135deg, rgba(99,102,241,0.15) 0%, rgba(15,23,42,0.9) 50%, rgba(99,102,241,0.1) 100%)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)', border: t.bg === '#f8fafc' ? `1px solid ${t.border}` : '1px solid rgba(99,102,241,0.25)', boxShadow: t.bg === '#f8fafc' ? '0 4px 20px rgba(0,0,0,0.08)' : '0 8px 32px rgba(99,102,241,0.15), inset 0 1px 0 rgba(255,255,255,0.1)', padding: '14px 12px', textAlign: 'center' }}>
              ...
              <div style={{ position: 'relative' }}>
                ...
                <div style={{ background: t.bg === '#f8fafc' ? t.cardBg2 : 'rgba(0,0,0,0.3)', backdropFilter: 'blur(20px)', WebkitBackdropFilter: 'blur(20px)', border: `1px solid ${t.border}`, borderRadius: '12px', padding: '14px', marginBottom: '8px', position: 'relative', overflow: 'hidden' }}>
                ...
                <div style={{ display: 'flex', gap: '8px' }}>
                  ...
                  <button onClick={() => navigate('/dashboard/withdraw')} style={{ flex: 1, background: t.bg === '#f8fafc' ? t.cardBg2 : 'rgba(255,255,255,0.08)', backdropFilter: 'blur(10px)', border: `1px solid ${t.border}`, color: t.text, fontSize: '11px', fontWeight: '600', padding: '10px', cursor: 'pointer', borderRadius: '10px', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px', marginBottom: '20px' }}>
              {Array.isArray(stats) && stats.map((s, i) => (
                <div key={i} style={{ position: 'relative', overflow: 'hidden', background: t.bg === '#f8fafc' ? t.cardBg : 'rgba(255,255,255,0.04)', backdropFilter: 'blur(16px)', WebkitBackdropFilter: 'blur(16px)', border: `1px solid ${t.border}`, borderRadius: '14px', padding: '12px 10px', minHeight: '90px', boxShadow: '0 4px 24px rgba(0,0,0,0.2), inset 0 1px 0 rgba(255,255,255,0.06)' }}>
                  {/* Gradient overlay */}
            ...
            {/* Transaction List */}
            <div style={{ background: t.bg === '#f8fafc' ? t.cardBg : 'rgba(255,255,255,0.04)', backdropFilter: 'blur(16px)', WebkitBackdropFilter: 'blur(16px)', border: `1px solid ${t.border}`, borderRadius: '12px', padding: '10px', boxShadow: t.bg === '#f8fafc' ? '0 4px 20px rgba(0,0,0,0.05)' : '0 4px 24px rgba(0,0,0,0.2)', marginBottom: '20px' }}>
