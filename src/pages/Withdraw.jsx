        ...
        <div onClick={() => setFeePopup(userFees.find(f => !f.paid))}
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <div>
              ...
              <div style={{ color: '#ef4444', fontSize: '8px', opacity: 0.8 }}>{userFees.filter(f => !f.paid && f.type !== 'registration').map(f => f.label).join(', ')} Required — Click to view and pay</div>
            </div>
          </div>
      ...
      {feePopup && (
        <>
          ...
          <div style={{ position: 'fixed', top: '50%', left: '50%', transform: 'translate(-50%,-50%)', zIndex: 301, background: 'white', padding: '36px 28px', width: '320px', textAlign: 'center', borderRadius: '8px' }}>
            ...
            <div style={{ color: '#111', fontSize: '14px', fontWeight: '700', marginBottom: '6px' }}>We're unable to process your withdrawal</div>
