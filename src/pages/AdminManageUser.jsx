            ...
            <div style={{ display:'flex', flexDirection:'column', gap:'6px', marginBottom:'14px' }}>
              {[
                ...
                <div key={opt.value} onClick={() => setEmailType(opt.value)}
                  style={{ padding:'8px 12px', background:emailType===opt.value?'rgba(99,102,241,0.1)':'#eef0f4', border:'1px solid '+(emailType===opt.value?'#6366f1':'#e2e8f0'), cursor:'pointer', color:emailType===opt.value?'#6366f1':'#555', fontSize:'11px', fontWeight:emailType===opt.value?'600':'400', borderRadius:'6px' }}>
                  {opt.label}
                </div>
              ))}
            </div>
            {emailType==='registrationFee' && (
              <div style={{ marginBottom:'12px' }}>
                ...
                <input value={regFeeAmount} onChange={e=>setRegFeeAmount(e.target.value)} placeholder="e.g. 250"
                  style={{ width:'100%', background:'#eef0f4', border:'1px solid #e2e8f0', color:'#111', fontSize:'11px', padding:'8px 10px', outline:'none', borderRadius:'6px', boxSizing:'border-box' }}/>
              </div>
            )}
              ...
              <>
                ...
                <div style={{ marginBottom:'14px' }}>
                  ...
                  <textarea value={emailMessage} onChange={e=>setEmailMessage(e.target.value)} placeholder="Type your message..." rows={4}
                    style={{ width:'100%', background:'#eef0f4', border:'1px solid #e2e8f0', color:'#111', fontSize:'11px', padding:'8px 10px', outline:'none', resize:'vertical', boxSizing:'border-box', borderRadius:'6px' }}/>
                </div>
              </>
            )}
