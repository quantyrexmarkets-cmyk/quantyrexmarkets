    ...
    <div style={{ display: 'flex', minHeight: '100vh', background: t.bg }}>
      ...
      <div style={{ flex: 1, padding: '24px', maxWidth: '600px' }}>
        <div style={{ marginBottom: '20px' }}>
          <button type="button" onClick={() => navigate('/dashboard/withdraw')} style={{ background: 'none', border: 'none', color: '#6366f1', fontSize: '12px', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '4px' }}>
            ← Back to Withdraw
          </button>
        </div>
          ...
          <div style={{ position: 'fixed', top: '50%', left: '50%', transform: 'translate(-50%,-50%)', zIndex: 301, background: 'white', padding: '36px 28px', width: '320px', textAlign: 'center', borderRadius: '8px', fontFamily: 'inherit' }}>
            {feeSuccess.allPaid ? (
              <>
                ...
                <button type="button" onClick={() => { setFeeSuccess(null); handleSubmit(); }}
                  style={{ width: '100%', padding: '10px', background: '#6366f1', border: 'none', color: 'white', fontSize: '10px', fontWeight: '700', cursor: 'pointer', marginBottom: '8px' }}>
