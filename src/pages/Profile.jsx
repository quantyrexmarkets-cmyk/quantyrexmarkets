          ...
          <div style={{ background: t.cardBg, padding: '16px', border: `1px solid ${t.border}` }}>
            ...
            {success && (
              <>
                ...
                <div style={{ position: 'fixed', top: '50%', left: '50%', transform: 'translate(-50%,-50%)', zIndex: 151, background: 'white', padding: '28px 20px', width: '260px', textAlign: 'center', borderRadius: '4px' }}>
                  ...
                  <button type="button" onClick={() => { setSuccess(false); setActiveTab('profile'); }} style={{ padding: '8px 28px', background: '#6366f1', border: 'none', color: 'white', fontSize: '10px', fontWeight: '600', cursor: 'pointer' }}>Okay</button>
                </div>
              </>
            )}
            ...
            <div style={{ marginBottom: '14px' }}>
              ...
              {(avatarPreview || (user?.avatar && user.avatar !== '')) && (
                ...
                <button type="button" onClick={handleRemoveAvatar} style={{ background: 'rgba(239,68,68,0.15)', border: '1px solid #ef4444', color: '#ef4444', fontSize: '7px', padding: '3px 8px', cursor: 'pointer', marginLeft: '8px' }}>Remove Photo</button>
