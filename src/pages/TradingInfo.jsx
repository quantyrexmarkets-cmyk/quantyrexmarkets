  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0e1628', color: 'white', fontFamily: "'Segoe UI', sans-serif" }}>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '40px 20px' }}>
        ...
        <button type="button" onClick={() => navigate('/signup')} style={{ background: '#6366f1', border: 'none', color: 'white', padding: '14px 32px', fontSize: '12px', fontWeight: '700', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '8px', marginTop: '32px' }}>
