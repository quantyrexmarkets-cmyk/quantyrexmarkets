...
export default function Terms() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0e1628', color: 'white', fontFamily: "'Segoe UI', sans-serif" }}>
      {/* Header */}
      <div style={{ background: '#1a2e4a', padding: '14px 20px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', borderBottom: `1px solid ${'rgba(255,255,255,0.08)'}`, position: 'relative', top: 0, zIndex: 100 }}>
      ...
      <div style={{ maxWidth: '800px', margin: '0 auto', padding: '40px 20px' }}>
        ...
        <div style={{ background: '#132035', padding: '20px', marginTop: '32px', textAlign: 'center' }}>
          ...
          <button type="button" onClick={() => navigate('/#contact')} style={{ background: '#6366f1', border: 'none', color: 'white', padding: '10px 24px', fontSize: '10px', fontWeight: '700', cursor: 'pointer' }}>Contact Us</button>
        </div>
      </div>
