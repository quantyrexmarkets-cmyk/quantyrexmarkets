...
const withdrawalApprovedEmail = (name, amount, currency, method, newBalance) => baseTemplate(`
  ...
  <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:0 0 28px;background-color:#121212;">
    <tr><td style="padding:12px 16px;border-bottom:1px solid #1a1a1a;color:#a0a0a0;">AMOUNT</td><td align="right" style="padding:12px 16px;border-bottom:1px solid #1a1a1a;color:#22c55e;font-size:13px;font-weight:600;">${formatMoney(amount, currency)}</td></tr>
    ...
    <tr><td style="padding:12px 16px;border-bottom:1px solid #1a1a1a;color:#a0a0a0;">NEW BALANCE</td><td align="right" style="padding:12px 16px;color:#ffffff;font-size:11px;">${formatMoney(newBalance, currency)}</td></tr>
