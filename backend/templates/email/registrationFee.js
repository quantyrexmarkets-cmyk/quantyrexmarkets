...
const registrationFeeEmail = (name, amount, currency) => baseTemplate(`
  ...
  <p style="color:#888888;font-size:12px;margin:0 0 20px;line-height:1.8;">A registration fee has been applied to your account.</p>
  <table width="100%" style="margin:20px 0;background:#0d1117;border:1px solid #1a1a1a;"><tr><td style="padding:16px;"><table width="100%">
    <tr><td style="padding:8px 0;border-bottom:1px solid #1a1a1a;"><span style="color:#666666;font-size:11px;">Fee</span></td><td align="right" style="padding:8px 0;border-bottom:1px solid #1a1a1a;"><span style="color:#ffffff;font-size:12px;">${currency}${parseFloat(amount || 0).toFixed(2)}</span></td></tr>
    <tr><td style="padding:8px 0;"><span style="color:#666666;font-size:11px;">Purpose</span></td><td align="right" style="padding:8px 0;"><span style="color:#888888;font-size:12px;">Account Activation</span></td></tr>
  </table></td></tr></table>
