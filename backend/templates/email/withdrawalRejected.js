...
const withdrawalRejectedEmail = (name, amount, currency, reason) => baseTemplate(`
  <div style="text-align:center;padding:10px 0 24px;">
    ...
    <p style="color:#505050;font-size:10px;margin:0 0 8px;letter-spacing:3px;font-family:'Montserrat',Arial,sans-serif;">WITHDRAWAL UPDATE</p>
    ...
    <p style="color:#ef4444;font-size:11px;margin:0;letter-spacing:2px;font-weight:500;font-family:'Montserrat',Arial,sans-serif;">• NOT APPROVED</p>
  </div>
  ...
  <p style="color:#9ca3af;font-size:12px;margin:0 0 20px;line-height:1.9;font-family:'Montserrat',Arial,sans-serif;font-weight:300;">We regret to inform you that your withdrawal request could not be processed at this time. Your funds have been returned to your account balance.</p>
  ...
  <p style="color:#9ca3af;font-size:12px;margin:0 0 24px;line-height:1.8;font-family:'Montserrat',Arial,sans-serif;font-weight:300;">Please contact our support team if you need assistance or wish to submit a new withdrawal request.</p>
  <div style="text-align:center;"><a href="https://quantyrexmarkets.vercel.app/dashboard" style="display:inline-block;color:#6366f1;font-size:10px;font-weight:500;padding:12px 32px;text-decoration:none;letter-spacing:2px;border:1px solid #6366f1;font-family:'Montserrat',Arial,sans-serif;">CONTACT SUPPORT</a></div>
