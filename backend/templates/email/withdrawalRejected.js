...
const withdrawalRejectedEmail = (name, amount, currency, reason) => baseTemplate(`
  ...
  <p style="color:#ef4444;font-size:10px;letter-spacing:3px;margin:0 0 12px;text-align:center;font-family:'Helvetica Neue',Arial,sans-serif;">WITHDRAWAL UPDATE</p>
  ...
  <p style="color:#a1a1aa;font-size:13px;margin:0 0 24px;line-height:1.8;font-family:'Helvetica Neue',Arial,sans-serif;">
    Dear <span style="color:#ffffff;">${name || 'Valued Client'}</span>, your withdrawal could not be processed. Funds have been returned to your balance.
  </p>
