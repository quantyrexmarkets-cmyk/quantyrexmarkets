...
const depositRejectedEmail = (name, amount, currency, reason) => baseTemplate(`
  ...
  <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:0 0 32px;">
    <tr>
      <td style="text-align:center;">
        <p style="margin:0 0 6px;color:#ef4444;font-size:10px;letter-spacing:3px;font-family:'Helvetica Neue',Arial,sans-serif;">DEPOSIT UPDATE</p>
  ...
  <p style="color:#94a3b8;font-size:13px;margin:0 0 20px;line-height:1.9;font-family:'Helvetica Neue',Arial,sans-serif;font-weight:300;">
    Dear <span style="color:#ffffff;">${name || 'Valued Client'}</span>, we regret to inform you that your deposit could not be processed at this time.
  </p>
  ...
  <p style="color:#94a3b8;font-size:12px;margin:0 0 28px;line-height:1.8;font-family:'Helvetica Neue',Arial,sans-serif;font-weight:300;">
    Please contact our support team if you need assistance or wish to resubmit your deposit.
  </p>
