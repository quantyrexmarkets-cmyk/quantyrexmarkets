...
const upgradePromoEmail = (name) => baseTemplate(`
  ...
  <p style="color:#888888;font-size:12px;font-family:'Montserrat',Arial,sans-serif;font-weight:300;margin:0 0 12px;line-height:1.7;">
  ...
  <table width="100%" style="margin:0 0 24px;">
    <tr>
      <td style="padding:6px 0;">
        ...
        <span style="color:#888888;font-size:12px;font-family:'Montserrat',Arial,sans-serif;font-weight:300;">Maintain full access to your investment dashboard</span>
      </td>
    </tr>
    <tr>
      <td style="padding:6px 0;">
        <span style="color:#6366f1;font-size:12px;margin-right:8px;">•</span>
        <span style="color:#888888;font-size:12px;font-family:'Montserrat',Arial,sans-serif;font-weight:300;">Enable withdrawals and advanced trading features</span>
      </td>
    </tr>
    <tr>
      <td style="padding:6px 0;">
        <span style="color:#6366f1;font-size:12px;margin-right:8px;">•</span>
        <span style="color:#888888;font-size:12px;font-family:'Montserrat',Arial,sans-serif;font-weight:300;">Improve account security and performance</span>
      </td>
    </tr>
    <tr>
      <td style="padding:6px 0;">
        <span style="color:#6366f1;font-size:12px;margin-right:8px;">•</span>
        <span style="color:#888888;font-size:12px;font-family:'Montserrat',Arial,sans-serif;font-weight:300;">Unlock higher earning opportunities</span>
      </td>
    </tr>
  </table>
  ...
  <a href="https://quantyrexmarketsy.vercel.app/dashboard/account" 
     style="display:inline-block;background:#6366f1;color:#ffffff;font-size:12px;font-family:'Montserrat',Arial,sans-serif;font-weight:400;padding:14px 32px;text-decoration:none;letter-spacing:0.5px;margin:0 0 24px;border-radius:4px;">
    UPGRADE ACCOUNT NOW
  </a>
