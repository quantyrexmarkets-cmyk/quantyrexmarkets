...
const depositPendingEmail = (name, amount, currency, method) => baseTemplate(`
  <p style="color:#f59e0b;font-size:10px;letter-spacing:3px;margin:0 0 12px;text-align:center;">DEPOSIT PENDING</p>
  ...
  <p style="color:#a1a1aa;font-size:13px;line-height:1.8;">Dear <span style="color:#fff;">${name || 'Client'}</span>, your deposit is being reviewed.</p>
  <table width="100%" cellpadding="0" cellspacing="0" border="0" style="margin:18px 0 28px;background:#121212;">
    ...
    <tr><td style="padding:12px 16px;color:#a0a0a0;">METHOD</td><td align="right" style="padding:12px 16px;color:#fff;">${method || 'Transfer'}</td></tr>
  </table>
