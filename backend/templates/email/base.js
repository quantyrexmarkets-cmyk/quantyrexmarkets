    ...
    <tr>
      <td align="center" style="padding:20px 0;">
        ...
        <table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:520px;background:#0a0a0a;border:1px solid #1a1a1a;">
          ...
          <!-- HEADER -->
          <tr>
            <td style="padding:24px 24px 16px 24px;" align="left">
          ...
          <tr>
            <td style="padding:0;">
              <div style="height:1px;background:#1a1a1a;margin:0 40px;"></div>
            </td>
          </tr>
          ...
          <tr>
            <td style="padding:20px 24px;" align="center">
              <p style="margin:0 0 5px 0;color:#ffffff;font-size:10px;line-height:1.5;">
                Questions? Contact support@quantyrexmarkets.com
              </p>
              <p style="margin:0;color:#888888;font-size:9px;">
