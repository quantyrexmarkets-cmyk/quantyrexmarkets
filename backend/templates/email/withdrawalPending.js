...
const withdrawalPendingEmail = (name, amount, currency, method) => baseTemplate(`
  ...
  <p style="color:#f59e0b;font-size:10px;letter-spacing:3px;margin:0 0 12px;text-align:center;font-family:'Helvetica Neue',Arial,sans-serif;">WITHDRAWAL REQUEST</p>
  ...
  <p style="color:#f59e0b;font-size:11px;letter-spacing:2px;font-weight:500;margin:0 0 32px;text-align:center;font-family:'Helvetica Neue',Arial,sans-serif;">PENDING REVIEW</p>

  <p style="color:#a1a1aa;font-size:13px;margin:0 0 24px;line-height:1.8;font-family:'Helvetica Neue',Arial,sans-serif;">
    Dear <span style="color:#ffffff;">${name || 'Valued Client'}</span>, your withdrawal request has been received and is under review. You will be notified once processed.
  </p>
    ...
    <tr>
      <td style="padding:12px 16px;">
        <table width="100%" cellpadding="0" cellspacing="0" border="0"><tr>
          ...
          <td align="right" style="color:#f59e0b;font-size:10px;font-weight:500;letter-spacing:1px;font-family:'Helvetica Neue',Arial,sans-serif;">PENDING</td>
        </tr></table>
      </td>
    </tr>
  </table>
    ...
    <tr>
      <td style="padding:12px 16px;">
        <p style="color:#a0a0a0;font-size:10px;margin:0;line-height:1.6;font-family:'Helvetica Neue',Arial,sans-serif;">
          Processing takes <span style="color:#a1a1aa;">24-48 hours</span>. Contact support if you have questions.
        </p>
      </td>
    </tr>
  </table>
