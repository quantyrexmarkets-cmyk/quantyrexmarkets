...
const withdrawalPendingEmail = (name, amount, currency, method) => baseTemplate(`
  ...
  <p style="color:#888888;font-size:12px;margin:0 0 20px;line-height:1.8;">We would like to inform you that your withdrawal request has been successfully received and is currently being processed.</p>
  <p style="color:#888888;font-size:12px;margin:0 0 20px;line-height:1.8;">Our team is reviewing the request to ensure a secure and accurate transaction.</p>
  <table width="100%" style="margin:20px 0;background:#0d1117;border:1px solid #1a1a1a;"><tr><td style="padding:16px;"><table width="100%">
    ...
    <tr><td style="padding:8px 0;"><span style="color:#666666;font-size:11px;">Status</span></td><td align="right" style="padding:8px 0;"><span style="color:#f59e0b;font-size:11px;font-weight:500;">PROCESSING</span></td></tr>
  </table></td></tr></table>
  ...
  <ul style="color:#888888;font-size:12px;margin:0 0 20px;padding-left:20px;line-height:2;">
    ...
    <li>Funds will be transferred once processing is complete</li>
    <li>You will be notified once the transaction is finalized</li>
  </ul>
