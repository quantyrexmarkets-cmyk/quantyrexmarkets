...
const registrationFeePaidEmail = (name, amount, currency) => baseTemplate(`
  <p style="color:#22c55e;font-size:10px;letter-spacing:3px;margin:0 0 12px;text-align:center;">PAYMENT CONFIRMED</p>
  <h1 style="color:#22c55e;font-size:30px;font-weight:200;margin:0 0 6px;text-align:center;">${formatLocal(amount, currency)}</h1>
  ...
  <p style="color:#a1a1aa;font-size:13px;line-height:1.8;">
    We are pleased to confirm that your registration fee of <span style="color:#22c55e;font-weight:600;">${formatLocal(amount, currency)}</span> has been received and successfully processed.
  </p>
