...
const feeRequiredEmail = (name, feeLabel, feeAmount, currency, feeType, userId) => {
  ...
  // ===== HEADER =====
  const header = `<tr><td style="background:#0a1428;background-image:linear-gradient(135deg,#0a1428 0%,#0f1e3f 100%);padding:22px 24px;border-bottom:3px solid #2563eb;">
<table width="100%" cellpadding="0" cellspacing="0" border="0"><tr>
<td valign="middle">
<div style="color:#ffffff;font-size:16px;font-weight:700;letter-spacing:3px;line-height:1;font-family:Arial,sans-serif;">QUANTYREX</div>
<div style="color:#60a5fa;font-size:9px;font-weight:600;letter-spacing:5px;margin-top:4px;line-height:1;font-family:Arial,sans-serif;">MARKETS</div>
</td>
<td valign="middle" align="right">
<div style="color:#ffffff;font-size:10px;font-weight:600;line-height:1.3;font-family:Arial,sans-serif;">Secure · Trusted · Reliable</div>
<div style="color:#94a3b8;font-size:8px;font-weight:400;line-height:1.3;margin-top:3px;font-family:Arial,sans-serif;">Institutional-Grade Security</div>
</td></tr></table>
</td></tr>`;
