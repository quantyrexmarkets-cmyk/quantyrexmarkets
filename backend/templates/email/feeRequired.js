...
<td style="padding:11px 18px;color:#d1d5db;font-size:11px;font-weight:400;font-family:${F};${isLast ? '' : 'border-bottom:1px solid #1a1a1a;'}">${text}</td>
</tr>`;
...
<table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#000000" style="background:#000000;border-radius:14px;border:1px solid #1a1a1a;">
...
<table width="100%" cellpadding="0" cellspacing="0" border="0" bgcolor="#000000" style="background:#000000;border-radius:10px;border:1px solid #1a1a1a;">
<tr>
${detailItem('CLIENT ID', clientId)}
${detailItem('TRANSACTION TYPE', fee.txType)}
</tr>
<tr><td colspan="2" style="border-top:1px solid #1a1a1a;height:1px;font-size:0;line-height:0;">&nbsp;</td></tr>
<tr>
