...
const { formatUSD, formatMoney, formatLocalMoney } = require('./_money');
...
const feeRequiredEmail = (name, feeLabel, feeAmount, currency, feeType, userId, localAmount, localCurrency) => {
...
<div style="color:#ffffff;font-size:18px;font-weight:500;line-height:1;letter-spacing:-0.3px;font-family:${F};">${localAmount != null ? formatLocalMoney(localAmount, localCurrency || currency) : formatMoney(feeAmount, currency)}</div>
</td>
